...
{
    [DbContext(typeof(SMSBODbContext))]
    [Migration("20220519140326_Added_StudentId_To_Mark")]
    partial class Added_StudentId_To_Mark
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMSBO.OfficeStaffs.OfficeStaff", b =>
                {
                    ...
                    b.ToTable("AppOfficeStaffs", (string)null);
                });

            modelBuilder.Entity("SMSBO.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SMSBO.Students.Student11", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppStudent11s", (string)null);
                });

            modelBuilder.Entity("SMSBO.Students.Student12", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppStudent12s", (string)null);
                });

            modelBuilder.Entity("SMSBO.Teachers.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ContextNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SMSBO.Vehicledetails.Vehicledetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppVehicledetails", (string)null);
                });
            ...
            modelBuilder.Entity("SMSBO.Marks.Mark", b =>
                {
                    b.HasOne("SMSBO.Students.Student", null)
                        .WithMany()
